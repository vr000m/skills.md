...
Draft a TIL or blog post from the current Codex session context.
...
- `/content-draft --type til --title "Building content skills for Codex"` — Draft with a specific title
...
Title suggestion: "Creating custom Codex skills for content review"
