...
Gradeable criteria for evaluating a completed compliance report. Doubles as a local self-check
before presenting the report to the user.

## Spec Resolution

- The spec reference resolved to a real, fetchable URL (RFC, draft, W3C/WHATWG spec, or direct
  link)
...
- Every normative RFC 2119 keyword in the section is captured (MUST, MUST NOT, SHALL, SHALL NOT,
...
- "Missing" findings note that the codebase was searched (target file plus adjacent modules and
  tests)
